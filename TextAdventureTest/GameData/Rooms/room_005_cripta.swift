...
//                                         "alternative_descriptions" : ["$AD1" : "La cripta è umida e con il pavimento di pietra. A $L1 c'è l'uscita verso lo studio.\nUna creatura giace a terra, morta."],
//                                         "objects" : [["id" : "$O1",
...
//                                         "alternative_descriptions" : ["$AD1" : "The cript is damp with a stone floor. To the $L1 there is the exit to the study room.\nA creature lying on the ground, dead."],
//                                         "objects" : [["id" : "$O1",
//                                                       "text" : localizedObjects.creature.localized,
//                                                       "alt_desc_id" : "$AD1",
//                                                       "actions" : [RoomData.ACTION_ID_$A8],
